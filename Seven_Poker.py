...
money = 200000000000
ptwomoney = pthreemoney = pfourmoney = ponemoney = 99999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999
betmoney= 4000000
formerbet = 0
...
def betting(myCard):#유저 배팅 함수
    ...
    print("1.하프 2.쿼터 3.체크 4.삥 5.다이 \n배팅 머니:",change(betmoney),  "\n보유머니:",change(money))
